        ...
        <tr>
          <td className="px-6 py-4 whitespace-nowrap">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <div className="text-sm font-medium text-gray-900 overflow-auto w-28" >{obj.schoolname}</div>
          ...
          <div className="text-sm text-gray-500 w-24 overflow-auto">{obj.schooldetail}</div>
          </td>
          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
          <div className="text-sm text-gray-500 w-24 overflow-auto">{obj.schooladdress}</div>
          </td>
          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
