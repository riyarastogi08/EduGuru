  ...
  return (
    <>
      ...
      <Swiper
        ...
        className="mySwiper"
      >
        <SwiperSlide><img className='w-full vh-10' src="https://post.medicalnewstoday.com/wp-content/uploads/sites/3/2022/01/play_therapy_GettyImages512117412_Header-1024x575.jpg" alt="" /></SwiperSlide>
