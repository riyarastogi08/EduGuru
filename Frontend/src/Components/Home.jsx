...
const Home = () => {
  return (
    ...
    "loadingClasses": "opacity-0"
            ...
            {/* End Clients */}
            {/* Works */}
            <div className="max-w-7xl px-4 lg:px-3 lg:px-4 py-12 lg:py-12 mx-auto">
              ...
              {/* Card Grid */}
              <div className=" grid grid-cols-2 gap-4 sm:gap-3 md:gap-4 lg:gap-6">
                {/* Card */}
                <a className="group block" href="#">
                  <div className="aspect-w-16 aspect-h-12 overflow-hidden bg-gray-100 rounded-2xl dark:bg-neutral-800">
                    <img
                      ...
                      src="https://images.app.goo.gl/TgKyTHvLZfSC23c17"
                  ...
                  <div className="pt-4">
                    ...
                    <p className="mt-1 text-gray-600 dark:text-neutral-400">
                      Know what suit your kid the most
                    </p>
                ...
                <a className="group block" href="#">
                  <div className="aspect-w-16 aspect-h-12 overflow-hidden bg-gray-100 rounded-2xl dark:bg-neutral-800">
                    <img
                      className="group-hover:scale-105 transition-transform duration-500 ease-in-out object-cover rounded-2xl"
                      src="https://images.app.goo.gl/87btrxoGooSUb3yT9"
                      alt="Image Description"
                    />
                  </div>
                  <div className="pt-4">
                    <h3 className="relative inline-block font-medium text-lg text-black before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full before:h-1 before:bg-lime-400 before:transition before:origin-left before:scale-x-0 group-hover:before:scale-x-100 dark:text-white">
                      MOST inquired playway
                    </h3>
                    <p className="mt-1 text-gray-600 dark:text-neutral-400">
                      View the most interesting playway of your type
                    </p>
                    <div className="mt-3 flex flex-wrap gap-2">
                      <span className="py-1.5 px-3 bg-white text-gray-600 border border-gray-200 text-xs sm:text-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400">
                        Know More
              ...
              <div className=" grid grid-cols-2 gap-4 sm:gap-3 md:gap-4 lg:gap-6">
                ...
                <a className="group block" href="#">
                  <div className="aspect-w-16 aspect-h-12 overflow-hidden bg-gray-100 rounded-2xl dark:bg-neutral-800">
                    <img
                      className="group-hover:scale-105 transition-transform duration-500 ease-in-out object-cover rounded-2xl"
                      src="https://images.app.goo.gl/LuzN7hy7hHoEocKW9"
                      alt="Image Description"
                    />
                  </div>
                  <div className="pt-4">
                    ...
                    <p className="mt-1 text-gray-600 dark:text-neutral-400">
                      Know about top schools of your interest
                    </p>
                    <div className="mt-3 flex flex-wrap gap-2">
                      <span className="py-1.5 px-3 bg-white text-gray-600 border border-gray-200 text-xs sm:text-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400">
                        Know more
                ...
                <a className="group block" href="#">
                  <div className="aspect-w-16 aspect-h-12 overflow-hidden bg-gray-100 rounded-2xl dark:bg-neutral-800">
                    <img
                      className="group-hover:scale-105 transition-transform duration-500 ease-in-out object-cover rounded-2xl"
                      src="https://images.app.goo.gl/Vg9bFrLqizaywFUY7"
                      alt="Image Description"
                    />
                  </div>
                  <div className="pt-4">
                    <h3 className="relative inline-block font-medium text-lg text-black before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full before:h-1 before:bg-lime-400 before:transition before:origin-left before:scale-x-0 group-hover:before:scale-x-100 dark:text-white">
                      MOST inquired schools
                    </h3>
                    <p className="mt-1 text-gray-600 dark:text-neutral-400">
                      View the most interesting school of youe type
                    </p>
                    <div className="mt-3 flex flex-wrap gap-2">
                      <span className="py-1.5 px-3 bg-white text-gray-600 border border-gray-200 text-xs sm:text-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400">
                        Know More
              ...
              <div className=" grid grid-cols-2 gap-4 sm:gap-3 md:gap-4 lg:gap-6">
                ...
                <a className="group block" href="#">
                  <div className="aspect-w-16 aspect-h-12 overflow-hidden bg-gray-100 rounded-2xl dark:bg-neutral-800">
                    <img
                      className="group-hover:scale-105 transition-transform duration-500 ease-in-out object-cover rounded-2xl"
                      src="https://images.app.goo.gl/nYMgrf5kG1wSTaoD8"
                      alt="Image Description"
                    />
                  </div>
                  <div className="pt-4">
                    ...
                    <p className="mt-1 text-gray-600 dark:text-neutral-400">
                      Know about top colleges to enhance your future
                    </p>
                    <div className="mt-3 flex flex-wrap gap-2">
                      <span className="py-1.5 px-3 bg-white text-gray-600 border border-gray-200 text-xs sm:text-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400">
                        Know more
                ...
                <a className="group block" href="#">
                  <div className="aspect-w-16 aspect-h-12 overflow-hidden bg-gray-100 rounded-2xl dark:bg-neutral-800">
                    <img
                      className="group-hover:scale-105 transition-transform duration-500 ease-in-out object-cover rounded-2xl"
                      src="https://images.app.goo.gl/EXJfmj9xFtKqMQJCA"
                      alt="Image Description"
                    />
                  </div>
                  <div className="pt-4">
                    ...
                    <p className="mt-1 text-gray-600 dark:text-neutral-400">
                      View the most interesting colleges
                    </p>
                    <div className="mt-3 flex flex-wrap gap-2">
                      <span className="py-1.5 px-3 bg-white text-gray-600 border border-gray-200 text-xs sm:text-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400">
                        Know More
              ...
              <div className="max-w-7xl px-4 lg:px-6 lg:px-8 py-12 lg:py-24 mx-auto">
                <blockquote className="max-w-4xl mx-auto">
                  <p className="mb-6 md:text-lg">
                    ...
                    <span className="text-neutral-500">Top 5 Edu Guru</span>
                  </p>
                  <p className="text-xl sm:text-2xl md:text-3xl md:leading-normal text-white">
                    EduGuru offers vast catalog of courses covering a wide range of playway, schools, colleges of yoyr interest,
                    whichever suits you, you can also add your institute of playway, school and college which can help other to have variety of options
                  </p>
