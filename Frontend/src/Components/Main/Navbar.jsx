  ...
  <div className="navbar-menu relative z-50 hidden">
    ...
    <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
      ...
      <div className="mt-auto">
        <div className="pt-6">
          <a
            className="block px-4 font-xl font-serif py-3 mb-3 leading-loose  text-center font-semibold leading-none bg-gray-50 hover:bg-gray-100 rounded-xl"
            href="#"
          >
            Sign in
          </a>
          <a
            className="block px-4 py-3 mb-2 leading-loose text-xl font-serif text-center text-white font-semibold bg-blue-900 hover:bg-blue-700  rounded-xl"
            href="#"
          >
            Sign Up
          </a>
